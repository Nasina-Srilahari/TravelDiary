...
// import { Editor } from 'react-draft-wysiwyg'; // Import a rich text editor component
// import draftToHtml from 'draftjs-to-html'; // Convert Draft.js content to HTML
...
//             const postData = {
//                 title: values.title,
//                 content: content, // Use the content state here
//             };
//             // Send postData to your backend to store in the database
//             console.log(postData);
//         },
//     });

//     const handleEditorChange = (content) => {
//         setContent(content); // Update the content state with the HTML content from the rich text editor
//     };
    ...
    const {
        ...
        onSubmit: async (values, actions) => {
            try {
                ...
                // Save the post data (including image URLs and user information) to the server
                await savePostData({ ...values, content: values.content }); // Save the HTML content as it is
