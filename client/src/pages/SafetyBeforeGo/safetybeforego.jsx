  ...
  useEffect(() => {
    ...
    const fetchWeatherData = async () => {
      try {
        ...
        const response = await fetch(`${apiUrl}?lat=20.5937&lon=78.9629&appid=${apiKey}`);
        ...
        >
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <WarningIcon color="primary" /> Legal Regulations: Familiarize yourself with local laws and regulations,
              such as the legal drinking age and restrictions on alcohol consumption and smoking in public areas.
              Violating these laws can result in legal consequences.<br></br><br></br>
              ...
              <CameraAltIcon color="primary" /> India has conservative dress and behavior standards.
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              <VisibilityIcon color="primary" />   Public demonstrations can occur throughout India  and may become violent.
          ...
          <Accordion>
            ...
            <AccordionDetails>
              ...
              Visa Requirement: If you are from outside India, you will need a visa in the form of an Electronic Travel Authority to enter India..<br></br><br></br>

              <InfoIcon color="primary" style={{ marginRight: '10px' }} />
              Digital Arrival & Departure Cards: India has introduced Digital Arrival & Departure Cards, which can be completed three days prior to travel.<br></br><br></br>

              <InfoIcon color="primary" style={{ marginRight: '10px' }} />
              Entry and Exit Conditions: Entry and exit conditions for India can change at short notice. Travelers should contact the nearest high commission, embassy, or consulate of India for the latest details.<br></br><br></br>

              <InfoIcon color="primary" style={{ marginRight: '10px' }} />
              Vaccination Requirements: Airlines may require proof of certain vaccinations to travel to India. Travelers should check requirements with individual airlines prior to travel.<br></br><br></br>
