        ...
        <div>
            ...
            <div className="homeContainer">
                    ...
                    <Card variant="outlined">
                        <CardContent>
                            ...
                            <Typography variant="body1">
                                <strong>Fire and Rescue Services:</strong> Call 112.
                            </Typography>
                            <br />
                            <Typography variant="body1">
                                <strong>Medical Emergencies:</strong> Call 108.
                            </Typography>
                            {/* <Typography variant="body2">
                            <strong>Tourist Helpline:</strong> 1363 or 1800 11 1363 
                            </Typography> */}
                            <br />
                            <Typography variant="body1">
                                <strong>Police:</strong> Call 100 or go to your local police station.
                            </Typography>
                            <br/>
                            <Typography variant="body2">
                            <strong>Tourist Helpline:</strong> 1363 or 1800 11 1363 
                            ...
                            <br />
                            <Typography variant="body1">
                                <strong>Tours Department:</strong> Call +91-11-23748115 or +91-11-23748164/65
                            </Typography>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                    ...
                    <button className="headerBtn" onClick={() => makePhoneCall('110')}>Call Fire and Rescue Services (112)</button>
                    <button className="headerBtn" onClick={() => makePhoneCall('110')}>Call Medical Emergencies (108)</button>
                    <button className="headerBtn" onClick={() => makePhoneCall('118')}>Call Police (100)</button>
                    <button className="headerBtn" onClick={() => makePhoneCall('119')}>Call Tourist Helpline (1363)</button>
                    <button className="headerBtn" onClick={() => makePhoneCall('+94112691111')}>Call Tourist Helpline (+91-11-23748115)</button>
